from model_components import SpatialGrid, StationaryPotential, StationaryPotentialParameters
...
if __name__ == '__main__':
    ...
    # potential_parameters = StationaryPotentialParameters(potential_type='coulomb', args={'height': 1, 'width': 1})
    potential_parameters = StationaryPotentialParameters(potential_type='feshbach', args={'a': 0.1, 'b': 0.8})
    ...
    tise_solver = TiseSolver(spatial_grid=spatial_grid,
                             stationary_potential=stationary_potential,
                             num_eigenstates=100,
